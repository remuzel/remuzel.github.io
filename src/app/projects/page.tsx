          ...
          <div className="space-y-8">
            {sortedProjects.length > 0 ? (
              ...
              <div className="bg-card-bg rounded-lg border border-border shadow-sm p-12 text-center">
                <h3 className="text-3xl font-bold mb-5 text-alexa-blue">Projects Under Construction!</h3>
                <div className="my-8 flex justify-center">
                  <LoadingAnimation size="md" />
                </div>
                <p className="text-foreground/80 mb-2 max-w-xl mx-auto">
                  I'm currently working on some exciting new projects to showcase here.
                </p>
                <p className="text-foreground/70 max-w-xl mx-auto">
                  Check back soon to see what I've been building. In the meantime, feel free to explore my GitHub repositories!
                </p>
                <a
                  href={SOCIAL.github}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 inline-flex items-center bg-alexa-blue text-white px-4 py-2 rounded-lg hover:bg-alexa-blue-dark transition-colors"
                >
